...
(), function () {
    function a() {
        for (var a = this._X, b = this._C, c = 0; 8 > c; c++)
            e[c] = b[c];
        ...
        a[0] = f[0] + (f[7] << 16 | f[7] >>> 16) + (f[6] << 16 | f[6] >>> 16) | 0,
        a[1] = f[1] + (f[0] << 8 | f[0] >>> 24) + f[7] | 0,
        a[2] = f[2] + (f[1] << 16 | f[1] >>> 16) + (f[0] << 16 | f[0] >>> 16) | 0,
        a[3] = f[3] + (f[2] << 8 | f[2] >>> 24) + f[1] | 0,
        a[4] = f[4] + (f[3] << 16 | f[3] >>> 16) + (f[2] << 16 | f[2] >>> 16) | 0,
        a[5] = f[5] + (f[4] << 8 | f[4] >>> 24) + f[3] | 0,
        a[6] = f[6] + (f[5] << 16 | f[5] >>> 16) + (f[4] << 16 | f[4] >>> 16) | 0,
        a[7] = f[7] + (f[6] << 8 | f[6] >>> 24) + f[5] | 0
    }
    var b = CryptoJS,
    ...
    g = b.algo.Rabbit = c.extend({
            _doReset: function () {
                for (var b = this._key.words, c = this.cfg.iv, d = 0; 4 > d; d++)
                    b[d] = 16711935 & (b[d] << 8 | b[d] >>> 24) | 4278255360 & (b[d] << 24 | b[d] >>> 8);
                for (var e = this._X = [b[0], b[3] << 16 | b[2] >>> 16, b[1], b[0] << 16 | b[3] >>> 16, b[2], b[1] << 16 | b[0] >>> 16, b[3], b[2] << 16 | b[1] >>> 16], b = this._C = [b[2] << 16 | b[2] >>> 16, 4294901760 & b[0] | 65535 & b[1], b[3] << 16 | b[3] >>> 16, 4294901760 & b[1] | 65535 & b[2], b[0] << 16 | b[0] >>> 16, 4294901760 & b[2] | 65535 & b[3], b[1] << 16 | b[1] >>> 16, 4294901760 & b[3] | 65535 & b[0]], d = this._b = 0; 4 > d; d++)
                    a.call(this);
                for (d = 0; 8 > d; d++)
                    b[d] ^= e[d + 4 & 7];
                if (c) {
                    ...
                    e = c >>> 16 | 4294901760 & d,
                    f = d << 16 | 65535 & c;
                    for (b[0] ^= c, b[1] ^= e, b[2] ^= d, b[3] ^= f, b[4] ^= c, b[5] ^= e, b[6] ^= d, b[7] ^= f, d = 0; 4 > d; d++)
                        a.call(this)
                }
            },
            _doProcessBlock: function (b, c) {
                var e = this._X;
                for (a.call(this), d[0] = e[0] ^ e[5] >>> 16 ^ e[3] << 16, d[1] = e[2] ^ e[7] >>> 16 ^ e[5] << 16, d[2] = e[4] ^ e[1] >>> 16 ^ e[7] << 16, d[3] = e[6] ^ e[3] >>> 16 ^ e[1] << 16, e = 0; 4 > e; e++)
                    d[e] = 16711935 & (d[e] << 8 | d[e] >>> 24) | 4278255360 & (d[e] << 24 | d[e] >>> 8), b[c + e] ^= d[e]
            },
            blockSize: 4,
            ivSize: 2
        });
...
(), function () {
    ...
    a.Utf16 = a.Utf16BE = {
        stringify: function (a) {
            var b = a.words;
            a = a.sigBytes;
            for (var c = [], d = 0; a > d; d += 2)
                c.push(String.fromCharCode(b[d >>> 2] >>> 16 - 8 * (d % 4) & 65535));
            return c.join("")
        },
        parse: function (a) {
    ...
    a.Utf16LE = {
        stringify: function (a) {
            ...
            a = a.sigBytes;
            for (var c = [], d = 0; a > d; d += 2)
                c.push(String.fromCharCode((b[d >>> 2] >>> 16 - 8 * (d % 4) & 65535) << 8 & 4278255360 | (b[d >>> 2] >>> 16 - 8 * (d % 4) & 65535) >>> 8 & 16711935));
            return c.join("")
        },
        parse: function (a) {
            for (var c = a.length, d = [], e = 0; c > e; e++) {
...
mpkModule.config(["$routeProvider", "$locationProvider", function (a) {
            ...
            return {
                ...
                saveSettings: function (a) {
                    ...
                    localStorage.setItem("myPersonalKanban.cloudSettings", angular.toJson(this.settings, !1)),
                    this.loadSettings(),
                    this.settings
                },
                ...
                uploadKanban: function (b) {
                    function c(a, b) {
                        for (var c = [], d = 0, e = a.length; e > d; d += b)
                            c.push(a.slice(d, b + d));
                        return c
                    }
                    function d(b) {
                        var c = {
                ...
                isConfigurationValid: function () {
                    return this.settings.notLoaded && this.loadSettings(),
                    void 0 != this.settings.kanbanKey && "" != this.settings.kanbanKey
                }
            }
        }
            ...
            return {
                ...
                lastUpdated: 0,
                add: function (a) {
                    return this.kanbansByName[a.name] = a,
                    this.save(),
                    a
                },
                all: function () {
                ...
                remove: function (a) {
                    return this.kanbansByName[a] && delete this.kanbansByName[a],
                    this.kanbansByName
                },
                ...
                save: function () {
                    ...
                    return localStorage.setItem("myPersonalKanban", a),
                    this.kanbansByName
                },
                load: function () {
                ...
                saveDownloadedKanban: function (c, d) {
                    ...
                    return this.kanbansByName = f.kanbans,
                    this.lastUsed = f.lastUsed,
                    this.theme = f.theme,
                    this.lastUpdated = d,
                    this.save(), {
                        success: !0
                ...
                renameLastUsedTo: function (a) {
                    ...
                    return delete this.kanbansByName[b.name],
                    b.name = a,
                    this.kanbansByName[a] = b,
                    this.lastUsed = a,
                    !0
                },
                "import": function (a) {
    ...
    return {
        ...
        removeColumn: function (a, b) {
            ...
            return a.columns.splice(c, 1),
            a.numberOfColumns--,
            a
        },
        addColumnNextToColumn: function (a, b, c) {
            var d = this.columnIndex(a, b);
            return "left" == c ? a.columns.splice(d, 0, new KanbanColumn("New column " + (a.numberOfColumns + 1))) : a.columns.splice(d + 1, 0, new KanbanColumn("New column " + (a.numberOfColumns + 1))),
            a.numberOfColumns++,
            a
        }
    }
    ...
    return {
        saveBlob: function (a, b) {
            ...
            a.colorOptions = ["FFFFFF", "DBDBDB", "FFB5B5", "FF9E9E", "FCC7FC", "FC9AFB", "CCD0FC", "989FFA", "CFFAFC", "9EFAFF", "94D6FF", "C1F7C2", "A2FCA3", "FAFCD2", "FAFFA1", "FCE4D4", "FCC19D"],
            a.$on("NewKanbanAdded", function () {
                a.showNewKanban = !1,
                a.kanban = c.getLastUsed(),
                a.allKanbans = Object.keys(c.all()),
                a.selectedToOpen = a.kanban.name,
                f.path("/kanban/" + a.kanban.name),
                a.switchToList = a.allKanbans.slice(0),
                a.switchToList.splice(0, 0, "Switch to ...")
            }),
            ...
            a.kanbanMenu = {},
            a.cloudMenu = {},
            a.kanbanMenu.openNewKanban = function () {
            ...
            a.kanbanMenu["delete"] = function () {
                if (confirm("You sure you want to delete the entire Kanban?")) {
                    ...
                    var b = j(c);
                    c.setLastUsed(b.length > 0 ? b[0] : void 0),
                    a.kanban = void 0,
                    a.allKanbans = Object.keys(c.all()),
                    a.allKanbans.length > 0 && a.switchToKanban(a.allKanbans[0]),
                    a.switchToList = a.allKanbans.slice(0),
                    a.switchToList.splice(0, 0, "Switch to ...")
                }
                return !1
            ...
            a.cloudMenu.upload = function () {
                if (!g.isConfigurationValid())
                    return a.openCloudSetup(!0);
                var b = c.upload();
                return a.errorMessage = "",
                a.showError = !1,
                a.infoMessage = "Uploading Kanban ...",
                a.showInfo = !0,
                a.showSpinner = !0,
                b.then(function (b) {
                    ...
                    a.showSpinner = !1,
                    a.showError = !0,
                    a.errorMessage = "There was a problem uploading your Kanban."
                }),
                !1
            },
            a.cloudMenu.download = function () {
                if (!g.isConfigurationValid())
                    return a.openCloudSetup(!0);
                a.infoMessage = "Downloading your Kanban ...",
                a.showSpinner = !0,
                a.showError = !1,
                a.errorMessage = "";
                var d = c.download();
                return d.success(function (a) {
                    ...
                    a.showError = !0,
                    a.showSpinner = !1,
                    a.errorMessage = "Problem Downloading your Kanban. Check Internet connectivity and try again."
                }),
                !1
            },
            ...
            a.editingName = !1,
            a.rename = function () {
                c.renameLastUsedTo(a.newName),
                c.save(),
                a.allKanbans = Object.keys(c.all()),
                a.editingName = !1,
                a.switchToKanban(a.newName)
            },
            ...
            l = c.load();
            l && (void 0 != e.kanbanName && c.get(e.kanbanName) ? k = c.get(e.kanbanName) : void 0 != c.getLastUsed() && (k = c.getLastUsed(), f.path("/kanban/" + k.name))),
            a.kanban = k,
            a.allKanbans = Object.keys(c.all()),
            a.selectedToOpen = a.newName = k.name,
            a.switchToList = a.allKanbans.slice(0),
            a.switchToList.splice(0, 0, "Switch to ..."),
            a.switchTo = "Switch to ...",
            a.$watch("kanban", function () {
                c.save()
            }, !0),
            a.columnHeight = angular.element(b).height() - 110,
            a.columnWidth = h(a.kanban.columns.length),
            a.triggerOpen = function () {
...
var NewKanbanController = ["$scope", "kanbanRepository", "kanbanManipulator", function (a, b, c) {
        a.model = {},
        a.$on("OpenNewKanban", function (b, c) {
            a.model.kanbanNames = c,
            a.model.kanbanName = "",
            a.model.numberOfColumns = 3,
            a.model.useTemplate = "",
            a.showNewKanban = !0
        }),
        a.createNew = function () {
            ...
            if ("" != a.model.useTemplate) {
                ...
                for (var f = 1; f < parseInt(a.model.numberOfColumns) + 1; f++)
                    c.addColumn(d, "Column " + f);
            return b.add(d),
            a.kanbanName = "",
            a.numberOfColumns = 3,
...
var ColumnSettingsController = ["$scope", "$timeout", function (a, b) {
        ...
        a.$on("OpenColumnSettings", function (b, c, d) {
            ...
            void 0 != d.settings && void 0 != d.settings.color && (a.model.color = d.settings.color),
            d.settings && d.settings.limit && (a.model.limit = d.settings.limit)
        }),
        ...
        a.update = function () {
            ...
            return b.name = a.model.columnName,
            void 0 == b.settings && (b.settings = {}),
            b.settings.color = a.model.color,
            "" != a.model.limit && (b.settings.limit = a.model.limit),
            a.showColumnSettings = !1,
            !0
        },
        a["delete"] = function () {
...
var NewKanbanCardController = ["$scope", "kanbanManipulator", function (a, b) {
        ...
        a.newCard = {},
        a.$on("AddNewCard", function (b, c) {
            a.kanbanColumnName = c.name,
            a.column = c,
...
angular.module("mpk").controller("NewKanbanCardController", NewKanbanCardController), angular.module("mpk").controller("KanbanController", ["$scope", "kanbanManipulator", function (a, b) {
            ...
            a.$on("DeleteColumn", function (c, d) {
                b.removeColumn(a.kanban, d),
                a.$emit("ColumnsChanged")
            }),
            a.$on("AddColumn", function (c, d, e) {
                b.addColumnNextToColumn(a.kanban, d, e),
                a.$emit("ColumnsChanged"),
                a.$broadcast("CloseColumnSettings")
            })
        }
    ]);
var SwitchThemeController = ["$scope", "themesProvider", "kanbanRepository", function (a, b, c) {
        a.model = {},
        a.model.themes = b.getThemes();
        var d = c.getTheme();
        (void 0 == d || "" == d) && (d = b.defaultTheme),
        a.model.selectedTheme = d,
        a.switchTheme = function () {
            b.setCurrentTheme(a.model.selectedTheme),
            c.setTheme(a.model.selectedTheme)
        },
...
var SetupCloudController = ["$scope", "cloudService", function (a, b) {
        ...
        a.model.showConfigurationError = !0,
        a.showCloudSetup = !1,
        a.$on("OpenCloudSetup", function () {
            var c = b.loadSettings();
            c.notSetup || (a.model.kanbanKey = c.kanbanKey, a.model.encryptionKey = c.encryptionKey, a.model.useLocalCloud = c.useLocalCloud, a.model.localCloudUrl = c.localCloudUrl),
            a.showCloudSetup = !0
        }),
...
angular.module("mpk").controller("SetupCloudController", SetupCloudController), angular.module("mpk").controller("ExportController", ["$scope", "kanbanRepository", "fileService", function (a, b, c) {
            ...
            a.showExportModal = !1,
            a.$on("OpenExport", function (b, c, d) {
                a.model.allKanbanNames = c,
                a.model.selectedKanban = d,
                a.showExportModal = !0
            }),
            a.doExport = function () {
                var d = null,
            ...
            a.showArchive = !1,
            a.$on("OpenArchive", function (b, d) {
                a.model.archived = c(d.archived),
                a.model.kanban = d,
                a.model.selectedCards = [],
                a.showArchive = !0
            }),
    ...
    return {
        ...
        link: function (a) {
            (void 0 === a.model || "" === a.model) && (a.model = a.options[0]),
            ...
            return {
                ...
                link: function (d, e, f, g) {
                    ...
                    angular.extend(j, a),
                    g ? (d.$watch(f.ngModel + ".length", function () {
                            b(function () {
                                e.sortable("refresh")
                            })
                        ...
                        b.item.sortable.received || (b.item.sortable.dropindex = b.item.index(), b.item.sortable.droptarget = b.item.parent(), e.sortable("cancel")),
                        i.detach(),
                        "clone" === e.sortable("option", "helper") && (i = i.not(i.last())),
                        i.appendTo(e),
                        b.item.sortable.received && !b.item.sortable.isCanceled() && d.$apply(function () {
                        ...
                        b.item.sortable.isCanceled() || d.$apply(function () {
                            ...
                            angular.forEach(a, function (a, b) {
                                ...
                                e.sortable("option", b, a)
                            })
                        }, !0), angular.forEach(k, function (a, b) {
                            j[b] = h(a, j[b])
                        })) : c.info("ui.sortable: ngModel not provided!", e),
                    e.sortable(j)
                }
            }
        }
    ...
    return {
        ...
        link: function (a, b, c) {
            a.title = c.title,
            a.style = "",
            c.modalStyle && (a.style = c.modalStyle),
    ...
    return {
        ...
        link: function (b, c, d) {
            ...
            a(f, b.config),
            e = new Spinner(b.config),
            e.spin(c[0]),
            b.$watch("config", function (a, b) {
                a != b && (e.stop(), h = !!a.config.hideElement, e = new Spinner(a), g || e.spin(c[0]))
            }, !0),
            d.hasOwnProperty("spinIf") && b.$watch("spinif", function (a) {
                ...
                link: function (c, d, e, f) {
                    function g() {
                        ...
                        a.jsonp(b.cloudAddress + "/service/kanban?callback=JSON_CALLBACK", {
                            ...
                            f.$setValidity("validKey", a.success),
                            f.$setValidity("validKeyUnableToVerify", !0)
                        }).error(function () {
